...
語法轉換器讓您能使用新的 JavaScript 語法，無需等待所有直譯器支援，從而提升編碼體驗
...
完整的 React Native 轉換功能清單可在 [@react-native/babel-preset](https://github.com/facebook/react-native/tree/main/packages/react-native-babel-preset) 查閱
