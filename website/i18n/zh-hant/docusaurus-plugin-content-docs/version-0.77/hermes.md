...
若您近期從零建立新應用，應在歡迎畫面中確認 Hermes 是否啟用：

![在 AwesomeProject 中查看 JS 引擎狀態的位置](/docs/assets/HermesApp.jpg)

JavaScript 中會存在全域變數 `HermesInternal` 可用於驗證 Hermes 是否運作：
...
此指令會在構建時將 JavaScript 編譯為 Hermes 位元組碼，從而提升裝置上的應用啟動速度。
