...
你可以在 [`AppearanceExample.js`](https://github.com/facebook/react-native/blob/main/packages/rn-tester/js/examples/Appearance/AppearanceExample.js) 找到完整的範例，該範例示範如何搭配 React 上下文使用此鉤子，為你的應用程式加入淺色與深色主題的支援。