...
當您的應用程式使用 [JavaScriptCore](https://trac.webkit.org/wiki/JavaScriptCore) (JSC) 作為運行環境時，您可以使用 Safari 來除錯 iOS 版本的應用程式。
...
:::note
若遇到問題，可能是某個 Chrome 擴充功能與偵錯工具產生意料之外的交互作用。請嘗試停用所有擴充功能後逐一重新啟用，直到找出造成問題的擴充元件。
:::