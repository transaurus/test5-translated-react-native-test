...
您還需要安裝 Xcode 命令行工具。開啟 Xcode，從選單選擇 **Settings... (或 Preferences...)**，進入 Locations 面板，從 Command Line Tools 下拉選單中選擇最新版本進行安裝。
...
此外，您還可添加其他環境變數，並在構建腳本階段引入 `.xcode.env` 檔案。若需執行特定環境的腳本，這是 **建議做法** ：可將構建階段與特定環境解耦。
