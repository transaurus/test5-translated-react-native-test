...
你可以在 [`AppearanceExample.js`](https://github.com/facebook/react-native/blob/main/packages/rn-tester/js/examples/Appearance/AppearanceExample.js) 找到完整範例，該範例示範如何將此鉤子與 React 上下文結合使用，為你的應用程式添加淺色與深色主題支援。