...
State 的工作原理與 React 中相同，因此有關處理狀態的更多細節，你可以查看 [React.Component API](https://react.dev/reference/react/Component#setstate)。此時，你可能已經注意到我們的大多數示例都使用默認的文字顏色。要自定義文字顏色，你必須[學習樣式](style.md)。