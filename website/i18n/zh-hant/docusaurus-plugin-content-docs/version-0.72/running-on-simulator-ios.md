...
若您安裝了多個 iOS 版本，還需指定對應版本。例如要在 iPhone 14 Pro（16.0 版）上運行應用程式，請執行以下指令：
...
您可指定從 `xcrun simctl list devices` 指令回傳的裝置 UDID。例如要使用 UDID `AAAAAAAA-AAAA-AAAA-AAAA-AAAAAAAAAAAA` 運行應用程式，請執行以下指令：
