...
你可以在 [`AppearanceExample.js`](https://github.com/facebook/react-native/blob/main/packages/rn-tester/js/examples/Appearance/AppearanceExample.js) 找到完整範例，該範例展示了如何將此 Hook 與 React context 結合使用，為你的應用程式添加淺色與深色主題支援。