...
本指南延續[原生元件](/docs/fabric-native-components-introduction)指南，假設您已熟悉該內容並了解[Codegen](/docs/next/the-new-architecture/what-is-codegen)。
...
現在是實作原生變更的時候了，這些變更將讓您的JS能直接呼叫原生視圖上的方法。
