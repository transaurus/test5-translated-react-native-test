...
- **若沒有任何監聽器返回 true 或未註冊監聽器**，則會執行預設的返回按鈕功能來退出應用程式。
...
[React Native Hooks](https://github.com/react-native-community/hooks#usebackhandler) 提供簡化事件監聽設定的 `useBackHandler` 鉤子。
